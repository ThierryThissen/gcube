...
void popupProjectWindow() {
  state.rebuildMainStack(() {
    stack.data.add(
      "mainProjectWindow",
      PopupGcubeWindow("mainProjectWindow", "Mes Projets G-Cube", Duration(milliseconds: 400)),
...
class PopupGcubeWindow extends StatefulWidget {
  final String id;
  final String title;
  final Duration duration;

  const PopupGcubeWindow(this.id, this.title, this.duration, {super.key});

  @override
  State<StatefulWidget> createState() => _PopupGcubeWindow();
}

class _PopupGcubeWindow extends State<PopupGcubeWindow> {
  ...
  Widget build(BuildContext context) {
    return OrientationBuilder(
      builder: (c, o) {
        double cWidth = mode.projectWindowOpen ? dsp.data.eqMaxWindowWidth * dsp.eqPx : 100 * dsp.eqPx;
        double cHeight = mode.projectWindowOpen ? dsp.data.eqMaxWindowHeight * dsp.eqPx : 20 * dsp.eqPx;
        Offset cAlign = mode.projectWindowOpen
        ...
        return AnimatedContainer(
          ...
          alignment: Alignment(cAlign.dx, cAlign.dy),
          child: Card(
                                                ...
                                                TextButton(
                                                  ...
                                                  onPressed: () {
                                                    state.rebuildMainStack(() {
                                                      setState(() {
                                                        ...
                                                        popupMessage(
                                                          width:
                                                              (dsp.data.eqMaxWindowWidth - 5 > 120 ? 120 : dsp.data.eqMaxWindowWidth - 5) * dsp.eqPx,
                                                          height: dsp.eqPx * 100,
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Card(
                                                      margin: EdgeInsetsGeometry.zero,
                                                      shape: RoundedRectangleBorder(
                                                        borderRadius: BorderRadiusGeometry.circular(mode.createProject ? dsp.eqPx * 0 : dsp.eqPx * 5),
                                                ...
                                                return TextButton(
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Card(
                                                      margin: EdgeInsetsGeometry.zero,
                                                      shape: RoundedRectangleBorder(
                                                        borderRadius: BorderRadiusGeometry.circular(GcubeProject.selected == GcubeProject.allProjects[index] ? dsp.eqPx * 0 : dsp.eqPx * 5),
                                                        side: BorderSide(color: color.uliege, width: dsp.eqPx * 1),
                                                      ),
                                                      color: color.background,
                                                      child: AnimatedContainer(
                                                        ...
                                                        height: GcubeProject.selected == GcubeProject.allProjects[index]
                                                            ? cpWinSide
                                                            : cpWinSide * .85,
                                                        width: GcubeProject.selected == GcubeProject.allProjects[index] ? cpWinSide : cpWinSide * .85,
                                                        alignment: Alignment.center,
                                                        child: Card(
                                                          margin: EdgeInsetsGeometry.zero,
                                                          shape: RoundedRectangleBorder(
